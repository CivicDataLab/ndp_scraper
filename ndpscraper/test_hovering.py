...
driver.get(
    "https://data.gov.in/catalog/overall-financing-pattern-public-sector-plan-outlay"
)
    ...
    try:
        ...
        if xpath_exists(driver_instance, catalog_info_xpath):
            if xpath_exists(driver_instance, catalog_info_xpath + "/following::a") and \
                    driver_instance.find_element(By.XPATH, catalog_info_xpath + "/following::a").text.startswith("More"):
